...
class SkillPackRuntime:
    ...
    def __init__(self, tool_engine=None, experience_store=None, hot_update_engine=None,
        ...
        Args:
            ...
            core_tool_manager: CoreToolManager 实例（用于热/冷工具分类，Tool RAG 集成）
        """
        ...
        if self.tool_engine is not None:
            ...
            for tool in tools:
                try:
                    ...
                    # 同步注册到 CoreToolManager（自动分类热/冷）
                    if self.core_tool_manager is not None:
        ...
        if self.tool_engine is not None:
            ...
            for tool in tools:
                try:
                    ...
                    # 同步从 CoreToolManager 注销
                    if self.core_tool_manager is not None:
                        self.core_tool_manager.unregister_tool(tool.name)
                except Exception as e:
