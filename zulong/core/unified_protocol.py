...
_WEB_TO_UNIFIED: Dict[str, str] = {
    ...
    "INTERACTION_EVENT": MessageType.INTERACTION_EVENT,
    "ATTENTION_UPDATE": MessageType.ATTENTION_UPDATE,
    "GRAPH_MEMORY_DIFF": MessageType.GRAPH_MEMORY_DIFF,
...
_UNIFIED_TO_WEB_DOWNLINK: Dict[str, str] = {
    ...
    MessageType.ATTENTION_UPDATE: "ATTENTION_UPDATE",
    MessageType.GRAPH_MEMORY_DIFF: "GRAPH_MEMORY_DIFF",
