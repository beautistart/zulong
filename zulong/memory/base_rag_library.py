    ...
    def load(self, path: str) -> bool:
        ...
        try:
            ...
            if os.path.exists(index_path):
                ...
                logger.info(f"[FAISSVectorStore] Index file not found: {index_path} (first run, starting with empty index)")
                return False
            ...
            if os.path.exists(map_path):
                ...
                logger.info(f"[FAISSVectorStore] Map file not found: {map_path} (first run)")
