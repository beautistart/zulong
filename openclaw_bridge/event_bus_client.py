...
class EventBusClient:
    ...
    def _run_websocket_client(self):
        ...
        try:
            ...
            subscribe_msg = {
                "type": "SUBSCRIBE",
                "event_types": ["ACTION_SPEAK", "L2_OUTPUT", "L2_OUTPUT_STREAM", "L2_THINKING_STEP", "SYSTEM_STATUS", "MEMORY_GRAPH_UPDATED"]
            }
    ...
    def _dispatch_remote_event(self, event_data: dict):
        ...
        try:
            ...
            event_type_map = {
                ...
                "L2_OUTPUT_STREAM": OpenClawEventType.L2_OUTPUT_STREAM,
                "L2_THINKING_STEP": OpenClawEventType.L2_THINKING_STEP,
                "SYSTEM_STATUS": OpenClawEventType.SYSTEM_STATUS,
                "MEMORY_GRAPH_UPDATED": OpenClawEventType.MEMORY_GRAPH_UPDATED,
            }
