...
**祖龙是一个具有异构记忆图谱、赫布学习、艾宾浩斯衰减、注意力控制和跨天级任务恢复的 AI Agent 认知系统**，在消费级硬件（RTX 3060 6GB）上即可运行完整的记忆+推理+多模态能力。
...
```bash
# 1. 启动 Python 后端（在 zulong/ 目录）
python zulong/ide/ide_server.py

# 2. 打开 VS Code，点击祖龙图标启动会话
```
...
|------|------|-----------|--------|--------------|---------|
| **异构记忆图谱** | ✅ NetworkX + JSON | ❌ 内存 DAG | ❌ | ❌ 单路向量 | ❌ 基于文件 |
| **赫布学习** | ✅ 共激活增强 | ❌ | ❌ | ❌ | ❌ |
| **艾宾浩斯衰减** | ✅ exp 衰减 | ❌ | ❌ | ❌ | ❌ 基于年龄 |
...
- [技术规格说明书 (TSD)](./docs/TSD_v2.4.md) - 完整系统架构设计
- [深度技术分析报告](./docs/祖龙系统深度技术分析报告.md) - 代码审查与竞品对比
- [IDE 使用指南](./docs/Zulong_IDE使用指南.md) - 用户操作手册
- [开源策略与商业化方案](./docs/祖龙开源策略与商业化方案.md) - 发布策略
- [竞品深度分析](./docs/祖龙系统竞品深度分析报告.md) - 市场调研
