...
//
// Covers:
//   - `zulong` launches interactive view (authed / unauthed)
...
// ---------------------------------------------------------------------------
// zulong (unauthenticated) → shows interactive auth view
// ---------------------------------------------------------------------------
test.describe("zulong (unauthenticated) — shows auth view", () => {
	test.use({
		program: { file: ZULONG_BIN, args: ["--tui"] },
		...TERMINAL_WIDE,
...
// ---------------------------------------------------------------------------
// zulong (authenticated) → shows main chat view
// ---------------------------------------------------------------------------
test.describe("zulong (authenticated) — shows chat view", () => {
	test.use({
		program: { file: ZULONG_BIN, args: ["--tui"] },
		...TERMINAL_WIDE,
