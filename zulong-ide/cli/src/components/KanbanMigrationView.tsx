		...
		() => [
			{
				...
				description: "Launch Zulong Kanban and start there by default.",
				value: "kanban",
			},
			{
				label: "Exit",
				description: "You can always run zulong --tui for the terminal experience.",
				value: "exit",
			},
		],
		[],
