 ...
 * about Zulong features while they wait.
 */
...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: 'Enable "Double-Check Completion" in settings to have Zulong verify its work before finishing a task.',
	},
	{
		text: "Add a .zulongrules file to your project root to give Zulong project-specific instructions.",
	},
	{
		text: "Press Tab to switch between Plan and Act mode — plan an approach before Zulong takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give Zulong access to external tools and APIs.",
	},
	{
		text: "Zulong creates checkpoints after changes — you can always restore to a previous state.",
	},
	{
	...
	{
		text: "Zulong can browse websites — ask it to test your local dev server in the browser.",
	},
	{
		text: "Use /reportbug to quickly file a GitHub issue with diagnostic context included.",
	},
	{
		text: "Try 'npm i -g zulong' to manage tasks on a Kankan board — orchestrate coding agents across worktrees.",
	},
	{
		text: "Use Shift+Tab to toggle auto-approve all — let Zulong work uninterrupted on trusted tasks.",
	},
	{
	...
	{
		text: "Use /skills to browse and attach reusable skill files that guide Zulong's behavior.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while Zulong is thinking/acting.
 */
