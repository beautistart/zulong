/**
 * Public types for the Zulong library API.
 *
 ...
 */
export type ZulongSessionEvents = {
...
/**
 * Options for creating a ZulongAgent instance.
 */
export interface ZulongAgentOptions {
	/** Whether debug logging is enabled */
	debug?: boolean
	/** Zulong Config Directory (defaults to ~/.zulong) */
	zulongDir?: string
...
/**
 * Extended session data stored by Zulong for ACP sessions.
 */
export interface ZulongAcpSession {
	/** Unique session ID */
	sessionId: SessionID
...
/**
 * State tracking for an active ACP session within Zulong.
 */
...
/**
 * Zulong-specific agent capabilities extending the ACP base capabilities.
 */
export interface ZulongAgentCapabilities {
...
/**
 * Zulong agent info for ACP initialization response.
 */
export interface ZulongAgentInfo {
	name: "zulong"
	title: "Zulong"
	version: string
}
 ...
 */
export interface ZulongPermissionOption {
...
/**
 * Result of translating a Zulong message to ACP session update(s).
 * A single Zulong message may produce multiple ACP updates.
 */
