...
import { ZULONG_CLI_DIR } from "./utils/path"

export { URI } from "vscode-uri"
export { ZulongFileStorage } from "@/shared/storage"

export const CLI_LOG_FILE = path.join(ZULONG_CLI_DIR.log, "zulong-cli.1.log")
