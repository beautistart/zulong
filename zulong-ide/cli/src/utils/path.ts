...
const data = process.env.ZULONG_DATA_DIR ?? path.join(os.homedir(), ".zulong", "data")

const log = process.env.ZULONG_LOG_DIR ?? path.join(data, "logs")

export const ZULONG_CLI_DIR = {
	data,
	log,
}
