 ...
 *   git diff | zulong 'explain' | zulong 'summarize'
 *
 * The challenge is that when chaining zulong commands, the first command may take
...
export async function readStdinIfPiped(): Promise<string | null> {
	...
	// isn't ready yet (common when piping from another zulong command)
