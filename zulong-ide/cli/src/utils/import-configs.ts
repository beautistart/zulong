...
export interface ImportedKey {
	provider: string // Zulong provider ID
	keyField: string // Zulong API key field name
...
/**
 * Map Codex key names to Zulong providers
 */
...
/**
 * Map OpenCode provider IDs to Zulong providers
 */
