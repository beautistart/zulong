...
describe("selectOutputMode", () => {
	...
	describe("piped stdin", () => {
		it("should use plain text mode when stdin was piped (echo x | zulong)", () => {
			const result = selectOutputMode({
				stdoutIsTTY: true,
		...
		it("should use plain text mode when stdin was piped but empty (echo '' | zulong 'prompt')", () => {
			const result = selectOutputMode({
				stdoutIsTTY: true,
				stdinIsTTY: false,
	...
	describe("real-world scenarios", () => {
		it("zulong (no args, interactive terminal)", () => {
			const result = selectOutputMode({
				stdoutIsTTY: true,
				stdinIsTTY: true,
				stdinWasPiped: false,
		...
		it('zulong "prompt" (prompt arg, interactive terminal)', () => {
			const result = selectOutputMode({
				stdoutIsTTY: true,
				stdinIsTTY: true,
				stdinWasPiped: false,
