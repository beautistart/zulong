...
describe("CLI Commands", () => {
	...
	beforeEach(() => {
		...
		program = new Command()
		program.name("zulong").description("Zulong CLI - AI coding assistant").version("0.0.0")
...
describe("getProviderModelIdKey", () => {
	...
	it("should return same key for zulong as openrouter", () => {
		expect(getProviderModelIdKey("zulong", "act")).toBe("actModeOpenRouterModelId")
	})
