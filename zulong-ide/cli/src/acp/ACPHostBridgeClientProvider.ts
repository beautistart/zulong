...
class ACPEnvServiceClient implements EnvServiceClientInterface {
	...
	async debugLog(request: proto.zulong.StringRequest): Promise<proto.zulong.Empty> {
		Logger.debug(request.value)
		return proto.zulong.Empty.create()
	}

	async clipboardWriteText(_request: proto.zulong.StringRequest): Promise<proto.zulong.Empty> {
		Logger.debug("[ACPEnvServiceClient] clipboardWriteText called (stub)")
		return proto.zulong.Empty.create()
	}

	async clipboardReadText(_request: proto.zulong.EmptyRequest): Promise<proto.zulong.String> {
		Logger.debug("[ACPEnvServiceClient] clipboardReadText called (stub)")
		return proto.zulong.String.create({ value: "" })
	}

	async getHostVersion(_request: proto.zulong.EmptyRequest): Promise<proto.host.GetHostVersionResponse> {
	...
	async getIdeRedirectUri(_request: proto.zulong.EmptyRequest): Promise<proto.zulong.String> {
		Logger.debug("[ACPEnvServiceClient] getIdeRedirectUri called (stub)")
		return proto.zulong.String.create({ value: "" })
	}

	async getTelemetrySettings(_request: proto.zulong.EmptyRequest): Promise<proto.host.GetTelemetrySettingsResponse> {
	...
	async shutdown(_request: proto.zulong.EmptyRequest): Promise<proto.zulong.Empty> {
	...
	async openExternal(request: proto.zulong.StringRequest): Promise<proto.zulong.Empty> {
...
class ACPWorkspaceServiceClient implements WorkspaceServiceClientInterface {
	...
	async openZulongSidebarPanel(
		_request: proto.host.OpenZulongSidebarPanelRequest,
	): Promise<proto.host.OpenZulongSidebarPanelResponse> {
		// Next phase: Send ACP extension notification to open Zulong sidebar.
		// This would show the Zulong panel/sidebar in the editor.
		Logger.debug("[ACPWorkspaceServiceClient] openZulongSidebarPanel called (stub)")
		return proto.host.OpenZulongSidebarPanelResponse.create({})
	}
