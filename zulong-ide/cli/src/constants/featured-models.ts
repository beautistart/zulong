/**
 * Featured models shown in the Zulong model picker during onboarding
 * These are curated models that work well with Zulong
 */
import { ZULONG_RECOMMENDED_MODELS_FALLBACK } from "@shared/zulong/recommended-models"
...
export const FEATURED_MODELS: FeaturedModelsByTier = {
	recommended: ZULONG_RECOMMENDED_MODELS_FALLBACK.recommended.map(toFeaturedModel),
	free: ZULONG_RECOMMENDED_MODELS_FALLBACK.free.map(toFeaturedModel),
}
