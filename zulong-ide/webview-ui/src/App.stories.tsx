...
import type { ZulongMessage, ZulongSayTool } from "@shared/ExtensionMessage"
...
const meta: Meta<typeof MockApp> = {
	...
	parameters: {
		...
		docs: {
			description: {
				component: `
The ChatView component is the main interface for interacting with Zulong. It provides a comprehensive chat experience with AI assistance, task management, and various tools.
...
const createMessage = (
	minutesAgo: number,
	type: ZulongMessage["type"],
	say: ZulongMessage["say"],
	text: string,
	overrides: Partial<ZulongMessage> = {},
): ZulongMessage => ({
...
const mockActiveMessages: ZulongMessage[] = [
...
const mockStreamingMessages: ZulongMessage[] = [
	...mockActiveMessages,
	createMessage(
		0.17,
		"say",
...
const createMockState = (overrides: any = {}) => ({
	...
	showWelcome: false,
	zulongMessages: mockActiveMessages,
...
export const Welcome: Story = {
	decorators: [createStoryDecorator({ welcomeViewCompleted: false, showWelcome: true, zulongMessages: [] })],
	parameters: {
		docs: {
			description: {
...
export const Onboarding: Story = {
	...
	play: async ({ canvasElement }) => {
		...
		const title = canvas.getByText("How will you use Zulong?")
		...
		await expect(canvas.getByText("How will you use Zulong?")).toBeInTheDocument()
...
export const EmptyState: Story = {
	decorators: [createStoryDecorator({ zulongMessages: [], taskHistory: [], isNewUser: true, showAnnouncement: true })],
	parameters: {
		docs: {
			description: {
...
export const ReturnUser: Story = {
	decorators: [
		createStoryDecorator({ zulongMessages: [], taskHistory: mockTaskHistory, isNewUser: true, showAnnouncement: false }),
	],
	parameters: {
		docs: {
			description: {
...
export const ActiveConversation: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "An active conversation showing a typical interaction with Zulong, including task creation, tool usage, and AI responses.",
			},
		},
	},
}
...
export const StreamingResponse: Story = {
	decorators: [createStoryDecorator({ zulongMessages: mockStreamingMessages })],
	parameters: {
		docs: {
			description: {
...
const createLongMessages = (): ZulongMessage[] => [
...
export const LongConversation: Story = {
	decorators: [createStoryDecorator({ zulongMessages: createLongMessages() })],
	parameters: {
		docs: {
			description: {
...
export const ErrorState: Story = {
	decorators: [createStoryDecorator({ zulongMessages: createErrorMessages() })],
	parameters: {
		docs: {
			description: {
				story: "Shows how Zulong handles and displays error messages, helping users understand and resolve issues.",
			},
		},
	},
}
...
export const AutoApprovalEnabled: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Shows the interface with auto-approval enabled, allowing Zulong to execute certain actions automatically without user confirmation.",
			},
		},
	},
}
...
export const PlanMode: Story = {
	decorators: [
		createStoryDecorator({
			zulongMessages: createPlanModeMessages(),
	...
	parameters: {
		docs: {
			description: {
				story: "Shows Zulong in Plan mode, where it focuses on creating detailed plans and discussing approaches before implementation.",
			},
		},
	},
}
...
export const BrowserAutomation: Story = {
	decorators: [createStoryDecorator({ zulongMessages: createBrowserMessages() })],
	parameters: {
		docs: {
			description: {
				story: "Shows Zulong performing browser automation tasks, including launching browsers, clicking elements, and testing web applications.",
			},
		},
	},
}
...
export const ToolApproval: Story = {
	decorators: [createStoryDecorator({ zulongMessages: createToolApprovalMessages() })],
	parameters: {
		docs: {
			description: {
...
export const Followup = quickStory(
	...
	"Shows followup question state where Zulong asks for next steps.",
)
...
export const PlanModeResponse = quickStory(
	...
	"plan_mode_respond",
	"Here's my comprehensive plan for refactoring your React application with TypeScript migration and performance optimization phases.\n\n\n\n\nPhase 1: TypeScript Migration\n1. Set up TypeScript in the project\n2. Rename .js files to .tsx/.ts\n3. Add type definitions for components and props\n4. Fix type errors and ensure type safety\n\nPhase 2: Performance Optimization\n1. Analyze current performance bottlenecks\n2. Implement code-splitting and lazy loading\n3. Optimize rendering with React.memo and useCallback\n4. Minimize bundle size with tree-shaking and minification\n5. Test performance improvements using profiling tools",
	"Shows plan mode response where Zulong presents a detailed plan for user approval.",
)
...
export const ReportBug = quickStory(
	...
	"report_bug",
	JSON.stringify({
		steps_to_reproduce: "1. Open Zulong\n2. Start a new task\n3. Observe the error",
		what_happened: "Zulong crashes unexpectedly",
	}),
...
export const DiffEditNewFormat: Story = {
	decorators: [createStoryDecorator({ backgroundEditEnabled: true, zulongMessages: createNewFormatMultiFileMessages() })],
	parameters: {
		docs: {
			description: {
...
export const DiffEditNewFormatStreaming: Story = {
	decorators: [
		(Story) => {
			const [messages, setMessages] = useState<ZulongMessage[]>([
			...
			const mockState = useMemo(() => createMockState({ backgroundEditEnabled: true, zulongMessages: messages }), [messages])
...
*** End Patch`
				...
				const timer1 = setTimeout(() => {
					setMessages((prev: ZulongMessage[]) => [
						...prev,
...
export const DiffEditReplaceDiffFormat: Story = {
	decorators: [createStoryDecorator({ backgroundEditEnabled: true, zulongMessages: createReplaceDiffFormatPatchMessages() })],
	parameters: {
		docs: {
			description: {
...
export const DiffEditMixedFormats: Story = {
	decorators: [createStoryDecorator({ zulongMessages: createMixedFormatMessages() })],
	parameters: {
		docs: {
			description: {
