import { EmptyRequest } from "@shared/proto/index.zulong"
		...
		return (
			<BaseRemoteConfigSection renderSectionHeader={renderSectionHeader}>
				<div className="flex flex-col justify-center gap-4">
					<h3>
						您尚未配置远程配置。请通过我们的{" "}
						<VSCodeLink href="https://app.zulong.ai/dashboard/organization?tab=settings">控制面板</VSCodeLink>.
					</h3>
