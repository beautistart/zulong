...
export function useScrollBehavior(
	...
	const [scrolledPastUserMessage, setScrolledPastUserMessage] = useState<ZulongMessage | null>(null)
	...
	const checkScrolledPastUserMessage = useCallback(() => {
		...
		let mostRecentScrolledPast: ZulongMessage | null = null
