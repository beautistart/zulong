...
const createTextMessage = (ts: number, text: string): ZulongMessage => ({
	type: "say",
	say: "text",
	text,
	ts,
...
const createToolMessage = (ts: number, tool: string): ZulongMessage => ({
	type: "say",
	say: "tool",
...
const createReasoningMessage = (ts: number, text: string): ZulongMessage => ({
	type: "say",
	say: "reasoning",
	text,
	ts,
