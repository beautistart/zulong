 ...
 */
export function useIdleIndicator(scrollContainerRef: React.RefObject<HTMLDivElement>, zulongMessages: ZulongMessage[]): boolean {
	...
	useEffect(() => {
		...
		const isTaskComplete = zulongMessages.some(
	...
	}, [scrollContainerRef, zulongMessages])
