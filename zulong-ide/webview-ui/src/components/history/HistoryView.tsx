import { BooleanRequest, EmptyRequest, StringArrayRequest } from "@shared/proto/zulong/common"
import { GetTaskHistoryRequest, TaskFavoriteRequest } from "@shared/proto/zulong/task"
			...
			<div className="p-2.5 border-t border-t-border-panel">
				...
				{selectedItems.length > 0 ? (
					<Button
						...
						variant="danger">
												删除 {selectedItems.length > 1 ? selectedItems.length : ""} 项已选
