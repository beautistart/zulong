...
- Official documentation: https://github.com/zulong/zulong
- API reference: https://api.zulong.ai/docs
- Support forum: https://community.zulong.ai

You can also visit our website at https://zulong.ai for more information.`,
		compact: false,
		showCursor: false,
	},
	parameters: {
