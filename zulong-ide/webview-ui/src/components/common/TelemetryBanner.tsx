import { TelemetrySettingEnum, TelemetrySettingRequest } from "@shared/proto/zulong/state"
...
export const TelemetryBanner: React.FC = () => {
	...
	return (
		<div className="bg-banner-background text-banner-foreground px-3 py-2 flex flex-col gap-1 shrink-0 mb-1 relative text-sm m-4">
			<h3 className="m-0">Help Improve Zulong</h3>
			<i>(and access experimental features)</i>
			<p className="m-0">
				Zulong collects error and usage data to help us fix bugs and improve the extension. No code, prompts, or personal
