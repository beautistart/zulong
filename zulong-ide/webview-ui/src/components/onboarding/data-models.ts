import type { OpenRouterModelInfo } from "@shared/proto/zulong/models"
...
export function getZulongUIOnboardingGroups(groupedModels: OnboardingModelGroup): OnboardingModelsByGroup {
