...
import type { ZulongToolResponseContent } from "@shared/messages"
...
export interface CommandExecutorCallbacks {
	...
	/**
	 * Update a zulong message by index
	 * Supports updating commandCompleted status and/or text content
	 */
	updateZulongMessage: (index: number, updates: { commandCompleted?: boolean; text?: string }) => Promise<void>
	/** Get zulong messages array */
	getZulongMessages: () => Array<{ ask?: string; say?: string; text?: string }>
...
export interface OrchestrationResult {
	...
	result: ZulongToolResponseContent
