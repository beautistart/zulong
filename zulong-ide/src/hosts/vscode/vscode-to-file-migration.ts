 ...
 * that data to the shared file-backed stores in ~/.zulong/data/ so all platforms
 ...
 *   globalStorageFsPath is still the VSCode-managed path (not ~/.zulong/data/),
 ...
 *   to ~/.zulong/data/ so that tasks created in VSCode are visible in CLI/JetBrains
