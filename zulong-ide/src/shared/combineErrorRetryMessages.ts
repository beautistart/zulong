 ...
 * @returns A new array of ZulongMessage objects with error_retry sequences consolidated.
 *
 * @example
 ...
 */
export function combineErrorRetryMessages(messages: ZulongMessage[]): ZulongMessage[] {
