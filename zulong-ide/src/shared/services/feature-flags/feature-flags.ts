...
export enum FeatureFlag {
	...
	// Feature flag for upstream Zulong recommended model cards
	ZULONG_RECOMMENDED_MODELS_UPSTREAM = "zulong-recommended-models-upstream",
	// Rollout flag for Zulong provider model sourcing:
	// off => OpenRouter model list, on => Zulong endpoint model list.
	EXTENSION_ZULONG_MODELS_ENDPOINT = "extension_zulong_models_endpoint",
...
export const FeatureFlagDefaultValue: Partial<Record<FeatureFlag, FeatureFlagPayload>> = {
	...
	[FeatureFlag.ZULONG_RECOMMENDED_MODELS_UPSTREAM]: false,
	[FeatureFlag.EXTENSION_ZULONG_MODELS_ENDPOINT]: false,
