export interface ZulongRecommendedModel {
	id: string
	name: string
	description: string
	tags: string[]
...
export interface ZulongRecommendedModelsData {
 ...
 */
export const ZULONG_RECOMMENDED_MODELS_FALLBACK: ZulongRecommendedModelsData = {
	recommended: [
		{
