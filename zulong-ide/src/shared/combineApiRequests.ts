...
/**
 * Combines API request start and finish messages in an array of ZulongMessages.
 *
 ...
 * @returns A new array of ZulongMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: ZulongMessage[]): ZulongMessage[] {
	const combinedApiRequests: ZulongMessage[] = []
