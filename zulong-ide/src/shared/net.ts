 ...
 * ## Proxy Support
 *
 * Zulong uses platform-specific fetch implementations to handle proxy
 * configuration:
 ...
 * 3. View logs: Check ~/.zulong/zulong-core-service.log for network-related
 *    failures.
