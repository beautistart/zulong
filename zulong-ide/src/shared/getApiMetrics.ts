...
/**
 * Calculates API metrics from an array of ZulongMessages.
 *
 ...
 */
export function getApiMetrics(messages: ZulongMessage[]): ApiMetrics {
 ...
 */
export function getLastApiReqTotalTokens(messages: ZulongMessage[]): number {
