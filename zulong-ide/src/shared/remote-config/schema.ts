...
// Zulong Provider model schema with per-model settings
export const ZulongModelSchema = z.object({
	id: z.string(), // The model ID is required
})

// Zulong Provider specific settings
export const ZulongSettingsSchema = z.object({
	// A list of the allowed models with their settings
	models: z.array(ZulongModelSchema).optional(),
})
...
const ProviderSettingsSchema = z.object({
	...
	Zulong: ZulongSettingsSchema.optional(),
...
// Settings for a global zulong rules or workflow file.
