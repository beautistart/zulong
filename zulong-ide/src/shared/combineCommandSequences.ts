...
/**
 * Combines sequences of command and command_output messages in an array of ZulongMessages.
 *
 * This function processes an array of ZulongMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of ZulongMessage objects to process.
 * @returns A new array of ZulongMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: ZulongMessage[]): ZulongMessage[] {
	const combinedCommands: ZulongMessage[] = []
