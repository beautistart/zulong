...
describe("State Keys Type Safety", () => {
	...
	describe("Type Exports", () => {
		...
		it("should export usable key types", () => {
			...
			const localKey: LocalStateKey = "localZulongRulesToggles"
		...
		it("should have LocalState keys map to ZulongRulesToggles", () => {
			const localState: Partial<LocalState> = {
				localZulongRulesToggles: {},
				localCursorRulesToggles: { "some-rule": true },
			}
			expect(localState.localZulongRulesToggles).to.deep.equal({})
		})
	})
	...
	describe("Edge Cases", () => {
		...
		it("should handle keys with special characters", () => {
			// The zulong:zulongAccountId key has a colon
			expect(SecretKeys).to.include("zulong:zulongAccountId")
			expect(isSecretKey("zulong:zulongAccountId")).to.be.true
		})
