...
// Local type definition - vscode-lm provider removed, but fields kept for storage compatibility
...
// executed automatically to regenerate the proto/zulong/state.proto file with the
...
const GLOBAL_STATE_FIELDS = {
	zulongVersion: { default: undefined as string | undefined },
	"zulong.generatedMachineId": { default: undefined as string | undefined }, // Note, distinctId reads/writes this directly from/to StorageContext before StateManager is initialized.
	...
	remoteRulesToggles: { default: {} as ZulongRulesToggles },
	remoteWorkflowToggles: { default: {} as ZulongRulesToggles },
	remoteSkillsToggles: { default: {} as ZulongRulesToggles },
	dismissedBanners: { default: [] as Array<{ bannerId: string; dismissedAt: number }> },
	// Path to worktree that should auto-open Zulong sidebar when launched
...
const API_HANDLER_SETTINGS_FIELDS = {
	...
	planModeZulongModelId: { default: undefined as string | undefined },
	planModeZulongModelInfo: { default: undefined as ModelInfo | undefined },
	...
	actModeZulongModelId: { default: undefined as string | undefined },
	actModeZulongModelInfo: { default: undefined as ModelInfo | undefined },
...
const USER_SETTINGS_FIELDS = {
	...
	globalZulongRulesToggles: { default: {} as ZulongRulesToggles },
	globalWorkflowToggles: { default: {} as ZulongRulesToggles },
	...
	zulongWebToolsEnabled: { default: true as boolean },
...
const SECRETS_KEYS = [
	"apiKey",
	"zulongApiKey",
	"zulongAccountId", // Zulong Account ID for Firebase
	"zulong:zulongAccountId",
	"openRouterApiKey",
	"awsAccessKey",
	"awsSecretKey",
	"awsSessionToken",
...
export type LocalState = { [K in (typeof LocalStateKeys)[number]]: ZulongRulesToggles }
