...
import { ZulongSyncStorage } from "./ZulongStorage"

export interface ZulongFileStorageOptions {
	/**
 ...
 */
export class ZulongFileStorage<T = any> extends ZulongSyncStorage<T> {
	protected name: string
	private data: Record<string, T>
	private readonly fsPath: string
	private readonly fileMode?: number

	constructor(filePath: string, name = "ZulongFileStorage", options?: ZulongFileStorageOptions) {
		super()
