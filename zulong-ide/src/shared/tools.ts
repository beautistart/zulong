...
export type ZulongTool = OpenAITool | AnthropicTool | GoogleTool

// Define available tool ids
export enum ZulongDefaultTool {
...
export const toolUseNames = Object.values(ZulongDefaultTool) as ZulongDefaultTool[]
