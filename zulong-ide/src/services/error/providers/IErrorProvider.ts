...
import type { ZulongError } from "../ZulongError"
...
export interface IErrorProvider {
	 ...
	 */
	captureException(error: Error | ZulongError, properties?: Record<string, unknown>): Promise<void>

	/**
	 * Sends a log message an error and optional properties
	 * @param error The error to log (Error or ZulongError)
	 * @param properties Optional additional properties to attach
	 */
	logException(error: Error | ZulongError, properties?: Record<string, unknown>): void
