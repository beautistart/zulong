...
export async function regexSearchFiles(
	...
	// Filter results using ZulongIgnoreController if provided
	const filteredResults = zulongIgnoreController
		? results.filter((result) => zulongIgnoreController.validateAccess(result.filePath))
		: results
