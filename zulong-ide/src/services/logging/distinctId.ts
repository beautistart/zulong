 ...
 */
export const _GENERATED_MACHINE_ID_KEY = "zulong.generatedMachineId"
 ...
 * This is updated to Zulong User ID when authenticated.
 */
 ...
 * If authenticated, this will be the Zulong User ID.
