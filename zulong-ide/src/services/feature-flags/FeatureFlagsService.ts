import { clearOnboardingModelsCache, getZulongOnboardingModels } from "@/core/controller/models/getZulongOnboardingModels"
import type { OnboardingModel } from "@/shared/proto/zulong/state"
...
export class FeatureFlagsService {
	...
	public async poll(userId: string | null): Promise<void> {
		...
		getZulongOnboardingModels() // Refresh onboarding models cache if relevant flag changed
	}
