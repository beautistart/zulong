...
export interface ITelemetryProvider {
	 ...
	 */
	identifyUser(userInfo: ZulongAccountUserInfo, properties?: TelemetryProperties): void
	 ...
	 * @param name Metric name (e.g., "zulong.tokens.input")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "zulong.api.duration_seconds")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "zulong.workspace.active_roots")
