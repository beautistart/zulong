...
import type { ZulongAccountUserInfo } from "../../../auth/AuthService"
...
export class OpenTelemetryTelemetryProvider implements ITelemetryProvider {
	...
	constructor(
		...
		if (meterProvider) {
			this.meter = meterProvider.getMeter("zulong")
			this.meterProvider = meterProvider
		}

		if (loggerProvider) {
			this.logger = loggerProvider.getLogger("zulong")
	...
	public identifyUser(userInfo: ZulongAccountUserInfo, properties: TelemetryProperties = {}): void {
	 ...
	 */
	private buildUserAttributes(userInfo: ZulongAccountUserInfo, properties: TelemetryProperties = {}): Record<string, string> {
