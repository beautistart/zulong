...
import type { ZulongFileStorage } from "@shared/storage/ZulongFileStorage"
import {
	applyTransform,
...
import { ZulongMemento } from "@/shared/storage"
...
/**
 * Read secrets from a ZulongFileStorage instance.
 */
export function readSecretsFromStorage(store: ZulongFileStorage<string>): Secrets {
...
/**
 * Read workspace state from a ZulongFileStorage instance.
 */
export function readWorkspaceStateFromStorage(store: ZulongFileStorage): LocalState {
...
/**
 * Read global state from a ZulongFileStorage instance.
 */
export async function readGlobalStateFromStorage(store: ZulongMemento): Promise<GlobalStateAndSettings> {
	try {
