...
# 
# Executes when the user submits a prompt to Zulong.
# 
# Input: { taskId, userPromptSubmit: { prompt: string, attachments: string[] }, zulongVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
...
# Notification Hook
#
# Executes when Zulong reaches a user-attention boundary or emits lifecycle notifications.
#
# Input: {
#   taskId,
#   notification: {
