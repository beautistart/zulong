...
import { HookOutput } from "../../../shared/proto/zulong/hooks"
...
describe("UserPromptSubmit Hook", () => {
	...
	describe("Hook Input Format", () => {
		it("should receive prompt text from user content", async function () {
			...
			const hookPath = path.join(tempDir, ".zulongrules", "hooks", "UserPromptSubmit")
...
console.log(JSON.stringify({
  ...
  contextModification: "GLOBAL: Prompt received"
			...
			const workspaceHookPath = path.join(tempDir, ".zulongrules", "hooks", "UserPromptSubmit")
