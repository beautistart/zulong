...
import type { ZulongTool } from "@/shared/tools"
import { ZulongToolSet } from ".."
import { getSystemPromptComponents } from "../components"
import { registerZulongToolSets } from "../tools"
...
export class PromptRegistry {
	...
	public nativeTools: ZulongTool[] | undefined = undefined

	private constructor() {
		registerZulongToolSets()
		this.load()
	}
	...
	async get(context: SystemPromptContext): Promise<string> {
		...
		this.nativeTools = ZulongToolSet.getNativeTools(variant, context)
