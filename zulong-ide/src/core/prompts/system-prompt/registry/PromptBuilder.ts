...
import { ZulongToolSet } from "../registry/ZulongToolSet"
import { type ZulongToolSpec, resolveInstruction } from "../spec"
...
export class PromptBuilder {
	...
	private static getEnabledTools(variant: PromptVariant, context: SystemPromptContext): ZulongToolSpec[] {
		return ZulongToolSet.getEnabledToolSpecs(variant, context)
	}
	...
	public static tool(config: ZulongToolSpec, registry: ZulongDefaultTool[], context: SystemPromptContext): string {
