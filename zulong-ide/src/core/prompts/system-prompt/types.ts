...
export interface PromptVariant {
	...
	// Tool configuration
	readonly tools?: readonly ZulongDefaultTool[] // Ordered list of tools to include
	readonly toolOverrides?: Readonly<Partial<Record<ZulongDefaultTool, ConfigOverride>>> // Tool customizations
}
...
export interface MutablePromptVariant {
	...
	tools?: ZulongDefaultTool[]
	toolOverrides?: Partial<Record<ZulongDefaultTool, ConfigOverride>>
}
...
export interface PromptConfig {
	...
	readonly tools?: readonly ZulongToolSpec[]
...
export interface SystemPromptContext {
	...
	readonly globalZulongRulesFileInstructions?: string
	readonly localZulongRulesFileInstructions?: string
	...
	readonly zulongIgnoreInstructions?: string
	...
	readonly zulongWebToolsEnabled?: boolean
...
export type ToolKey = keyof typeof ZulongDefaultTool
export type ToolValue = (typeof ZulongDefaultTool)[ToolKey]
...
export function isValidZulongDefaultTool(tool: string): tool is ZulongDefaultTool {
	return Object.values(ZulongDefaultTool).includes(tool as ZulongDefaultTool)
}
...
export interface VariantBuilder {
	...
	tools(...tools: ZulongDefaultTool[]): this
	overrideTool(tool: ZulongDefaultTool, override: ConfigOverride): this
...
export const TASK_PROGRESS_PARAMETER = {
	...
	dependencies: [ZulongDefaultTool.TODO],
}
