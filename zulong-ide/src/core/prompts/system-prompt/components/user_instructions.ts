...
export async function getUserInstructions(variant: PromptVariant, context: SystemPromptContext): Promise<string | undefined> {
	const customInstructions = buildUserInstructions(
		context.globalZulongRulesFileInstructions,
		context.localZulongRulesFileInstructions,
		...
		context.zulongIgnoreInstructions,
...
function buildUserInstructions(
	globalZulongRulesFileInstructions?: string,
	localZulongRulesFileInstructions?: string,
	localCursorRulesFileInstructions?: string,
	localCursorRulesDirInstructions?: string,
	localWindsurfRulesFileInstructions?: string,
	localAgentsRulesFileInstructions?: string,
	zulongIgnoreInstructions?: string,
	...
	if (globalZulongRulesFileInstructions) {
		customInstructions.push(globalZulongRulesFileInstructions)
	}
	if (localZulongRulesFileInstructions) {
		customInstructions.push(localZulongRulesFileInstructions)
	}
	...
	if (zulongIgnoreInstructions) {
		customInstructions.push(zulongIgnoreInstructions)
	}
