...
import type { ZulongIgnoreController } from "@core/ignore/ZulongIgnoreController"
...
import type { ZulongContent } from "@shared/messages/content"
...
export interface TaskCallbacks {
	...
	sayAndCreateMissingParamError: (toolName: ZulongDefaultTool, paramName: string, relPath?: string) => Promise<any>
