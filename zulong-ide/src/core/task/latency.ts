...
const localCadenceOverride = readCadenceOverride("ZULONG_PRESENTATION_CADENCE_MS")
const remoteCadenceOverride = readCadenceOverride("ZULONG_REMOTE_PRESENTATION_CADENCE_MS")
const schedulingDisabled = readBooleanEnv("ZULONG_DISABLE_PRESENTATION_SCHEDULER")
