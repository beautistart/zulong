...
// 'Add to Zulong' context menu in editor and code action
// Inserts the selected code into the chat.
export async function addToZulong(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
	...
	Logger.log("addToZulong", request.selectedText, filePath, request.language)
