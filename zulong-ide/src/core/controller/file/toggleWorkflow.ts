import { ZulongRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/zulong/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<ZulongRulesToggles> {
	...
	return ZulongRulesToggles.create({ toggles: toggles })
}
