import type { ToggleAgentsRuleRequest } from "@shared/proto/zulong/file"
 ...
 */
export async function toggleAgentsRule(controller: Controller, request: ToggleAgentsRuleRequest): Promise<ZulongRulesToggles> {
