import type { ToggleCursorRuleRequest } from "@shared/proto/zulong/file"
import { ZulongRulesToggles } from "@shared/proto/zulong/file"
 ...
 */
export async function toggleCursorRule(controller: Controller, request: ToggleCursorRuleRequest): Promise<ZulongRulesToggles> {
	...
	return ZulongRulesToggles.create({
