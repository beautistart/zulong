 ...
 */
export function convertApplyPatchToolCalls(messages: Array<ZulongStorageMessage>): Array<ZulongStorageMessage> {
 ...
 */
export function convertWriteToFileToolCalls(messages: Array<ZulongStorageMessage>): Array<ZulongStorageMessage> {
	// Map to track tool_use_id to converted tool info and original input
