...
export const addSelectedCodeToZulongWebview = async (_page: Page) => {
	...
	const addToZulong = _page.getByText(/Add to Zulong/i)
	await addToZulong.waitFor({ state: "visible" })
