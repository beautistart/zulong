...
import { CreateHookRequest, DeleteHookRequest, ToggleHookRequest } from "../shared/proto/zulong/file"
...
describe("Hook Management", () => {
	...
	beforeEach(async () => {
		...
		globalHooksDir = path.join(tempDir, "global", "Documents", "Zulong", "Hooks")
		workspaceHooksDir = path.join(tempDir, "workspace", ".zulongrules", "hooks")
	...
	describe("Edge Cases", () => {
		it("should handle missing .zulongrules directory gracefully", async function () {
			this.timeout(5000)
