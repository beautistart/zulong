...
import type { ZulongAPI } from "../exports/zulong"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("ZulongAPI Core Functionality", () => {
	let api: ZulongAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createZulongAPI expects
		...
		// Create API instance
		api = createZulongAPI(mockController)
	})
